...
const Carousel = () => {
    ...
    return (
        <Slider {...settings} className='text-white'>
            <div className='bg-carousel-img-1 md:h-screen bg-center bg-cover slide justify-center items-center space-x-10'>
                <div className='md:flex max-w-6xl mt-12 py-7 px-2 sm:p-7'>
                    <div className='md:flex-1 mb-6'>
                        ...
                        <p className='mb-5'>Nature is beauty and beauty is Nature. Setting Sun, starry night, silvery light of the Moon, snow-covered mountains, deep and dark forests, scent and fragrance of flowers are some of the beauties of Nature</p>
            ...
            <div className='bg-carousel-img-2 md:h-screen bg-center bg-cover slide justify-center items-center space-x-10'>
                <div className='md:flex max-w-6xl mt-12 py-7 px-2 sm:p-7'>
                    <div className='md:flex-1 mb-6'>
                        <h4 className='text-2xl mb-5'>Hiking</h4>
                        <h1 className='text-5xl sm:text-6xl mb-5 font-bold'>Let's Explore The Best Nature</h1>
                        <p className='mb-5'>World has lands of enormous beauty, hundreds of serpentine rivers, crystal clear water lakes surrounded by ever green hills, luxuriant tropical rain forests, beautiful cascades of green tea gardens, world's largest mangrove forest preserved as World Heritage</p>
                        <button className='bg-red-400 px-8 py-4 rounded-lg text-xl font-bold'>Discover More</button>
                    </div>
                    <div style={{ backgroundColor: 'rgba(255, 255, 255, .3)'}} className='py-20 sm:pl-12 sm:pr-40 px-10 backdrop-blur-3xl rounded-lg'>
                        <div className='flex items-center mb-8'>
                            ...
                            <div className='ml-5'>
                                <p className='font-bold text-lg'>Location</p>
                                <p className='font-light'>Finland</p>
                            </div>
                        </div>
                        <div className='flex items-center mb-8'>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 rounded-full text-red-400 bg-white p-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className='ml-5'>
                                <p className='font-bold text-lg'>Durations</p>
                                <p className='font-light'>3 Days</p>
                            </div>
                        </div>
                        <div className='flex items-center mb-8'>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 rounded-full text-red-400 bg-white p-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className='ml-5'>
                                <p className='font-bold text-lg'>Max People</p>
                                <p className='font-light'>5 People</p>
                            </div>
                        </div>
